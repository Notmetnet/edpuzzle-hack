...
const speedUpVideo = ElementBuilder.create(pDocument, "button", "btn").setText("Speed Up Video.");
...
let MAIN_JSON_DATA;
function createHtmlPayload(json_content, filename) {
...
function downloadHtmlPayload(json_data) {
    try {
